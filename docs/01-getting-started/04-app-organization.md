...
After initialization, you will receive Sidebar, Page, getStaticParams, getMetadata, getPageData, and revalidate. Read more on the [Initialization](./03-initialization.md) page.
